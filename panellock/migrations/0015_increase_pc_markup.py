...
def set_pc_markup(apps, schema_editor, markup_percent):
...
def increase_pc_markup(apps, schema_editor):
    set_pc_markup(apps, schema_editor, Decimal("50.00"))


def restore_pc_markup(apps, schema_editor):
    set_pc_markup(apps, schema_editor, Decimal("15.00"))


class Migration(migrations.Migration):
    dependencies = [("panellock", "0014_update_edge_panel_license")]

    operations = [migrations.RunPython(increase_pc_markup, restore_pc_markup)]
