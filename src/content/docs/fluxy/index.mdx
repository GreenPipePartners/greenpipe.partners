...
:::tip[Gateway function reference]
[View all 28 functions declared by the Fluxy Free Gateway module](/docs/flux/0.1.0/fluxy/gateway-functions/), including request fields, responses, access levels, and version adapters.
:::

## Examples

- [Analyze Ignition tag values with NumPy](/docs/flux/0.1.0/fluxy/examples/numpy/): batch-read qualified values, calculate vectorized statistics, and write derived values back to Ignition.
...
See the [complete Gateway function reference](/docs/flux/0.1.0/fluxy/gateway-functions/) for every native module route and payload.
