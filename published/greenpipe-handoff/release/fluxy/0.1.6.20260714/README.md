# Fluxy Free Public Beta 0.1.6.20260714
...
- `Fluxy-Ignition81-Free-0.1.6.20260714.modl`: Ignition 8.1.50+
- `Fluxy-Ignition83-Free-0.1.6.20260714.modl`: Ignition 8.3.4+

Install only the artifact matching the Gateway's major version. Both artifacts use module ID `partners.greenpipe.fluxy`, set `freeModule=true`, and require no Fluxy module entitlement. The Java implementation and Gateway hook use namespace `partners.greenpipe.fluxy.gateway`.
...
```text
d05c56d87463bf1c805196f0565febab2613ca722e67e458ba2a99c4e77adb8b  Fluxy-Ignition81-Free-0.1.6.20260714.modl
dbe97f8f8294053c10fa18bd74e5247eae6e1ff9051e93a57bf7b182197e026e  Fluxy-Ignition83-Free-0.1.6.20260714.modl
...
- Tag: `v0.1.6.20260714`
- Commit: `354ea093ae3db11de712c463f9529db55f2c042d`
- Source: https://github.com/GreenPipePartners/Fluxy-modl/tree/v0.1.6.20260714
- License: MPL-2.0
...
- Java source, test, hook, and archive namespaces are uniformly `partners.greenpipe.fluxy.gateway`.
...
- Ignition reported `partners.greenpipe.fluxy`, state `ACTIVE`, license state `Free`.
- Authenticated project scan and tag configuration/read/write/delete tests passed on Ignition 8.3.4.
