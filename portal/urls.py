...
urlpatterns = [
    ...
    path("taxdesk/", views.taxdesk, name="taxdesk"),
    path("taxdesk/connect/", views.taxdesk_connect, name="taxdesk_connect"),
    path("taxdesk/disconnected/", views.taxdesk_disconnected, name="taxdesk_disconnected"),
    path(
        "taxdesk/quickbooks/callback/",
        views.taxdesk_quickbooks_callback,
        name="taxdesk_quickbooks_callback",
    ),
