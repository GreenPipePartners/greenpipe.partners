...
class PortalSmokeTests(SimpleTestCase):
    def test_homepage_renders(self):
        ...
        self.assertContains(response, ">General</button>", count=1)
        self.assertContains(response, ">Update</button>", count=1)
        self.assertContains(response, ">Spare</button>", count=1)
